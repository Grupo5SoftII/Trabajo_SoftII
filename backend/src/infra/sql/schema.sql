...
INSERT INTO usuarios (id, nombre, apellidos, edad, tipo, usuario) VALUES
  (1, 'Ana', 'García', 34, 'PROFESOR', 'profe.ana'),
  (2, 'Luis', 'Pérez', 8, 'ALUMNO', 'luisito2025'),
  (3, 'Mia', 'López', 9, 'ALUMNO', 'mia.lopez')
ON CONFLICT (id) DO NOTHING;
